...
import { checkTodoExists } from './helper';
...
const TodoApp = () => {
 ...
 const [popup, setPopup] = useState(false);
  ...
  function handleFormSubmit(e) {
    e.preventDefault();
    let response = checkTodoExists(todos, todo);
    if (response === true) {
      alert('Alreay Exists, Please Enter other todo!');
    }
  ...
  function handleUpdateTodo(id, updatedTodo) {
    ...
    let response = checkTodoExists(todos, updatedTodo.text);
    if (response === true) {
      alert('Alreay Exists, Please Enter other todo!');
    }
